...
```html
<!-- The CSS file for the core of Font Awesome Elite and all its icon families -->
...
Also, for example, in the **[index.html](https://github.com/elmarmehrabov/Font-Awesome-Elite/blob/main/test/index.html)** file inside the **test** folder of the repository, with all icon families and all icon styles usage forms of the [house icon](https://fontawesome.com/icons/house?f=classic&s=solid) are shown.
